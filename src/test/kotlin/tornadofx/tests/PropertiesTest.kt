...
class PropertiesTest {
    ...
    @Test fun propertyFromMapKey() {
        ...
        val helloProperty: Property<String> = map.toProperty("hello") { v: String? -> SimpleStringProperty(v) }
        val numberProperty: Property<Number> = map.toProperty("number") { v: Number? -> SimpleIntegerProperty(v!!.toInt()) }
